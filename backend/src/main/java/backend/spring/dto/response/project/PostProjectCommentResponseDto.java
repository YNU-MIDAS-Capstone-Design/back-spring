...
@Getter
public class PostProjectCommentResponseDto extends ResponseDto {

    private PostProjectCommentResponseDto() {
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
    }

    public static ResponseEntity<PostProjectCommentResponseDto> success() {
        PostProjectCommentResponseDto result = new PostProjectCommentResponseDto();
