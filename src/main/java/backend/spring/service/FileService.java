...
public class FileService {
    ...
    @Value("${file.path}")
    private String filePath; //application.yml의 파일경로를 부여함
    ...
    public String file_upload(String type, MultipartFile file) {
        ...
        String uuid = UUID.randomUUID().toString(); //파일 이름이 겹치지 않도록 uuid로 바꿈
    ...
    public Boolean file_delete(String type, String fileName){
        String path = filePath + type + "/" + fileName;
